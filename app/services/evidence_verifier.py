...
def verify_claim_evidence(
    ...
    *,
    ...
    """Fetch and compare evidence leads conservatively.

    Returns (claims, fetched_source_count, verified_evidence_count). Network failures are
    recorded on evidence items and never cause a claim to be promoted or demoted.
    """
